...
export const FloatingNav = ({
 ...
 // Set initial visibility to true to always show the navbar
      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-white items-center flex space-x-1 text-white dark:hover:text-white hover:text-neutral-500"
            )}
          >
